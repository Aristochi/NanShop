...
public class NanShopMallCarouselController {

    @Resource
    NanShopMallCarouselService nanShopMallCarouselService;

    @GetMapping("/carousels")
    public String carouselPage(HttpServletRequest request) {
        request.setAttribute("path", "nanShop_mall_carousel");
        return "admin/nanShop_mall_carousel";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(nanShopMallCarouselService.getCarouselPage(pageUtil));
    }
    ...
    public Result save(@RequestBody Carousel carousel) {
        ...
        String result = nanShopMallCarouselService.saveCarousel(carousel);
    ...
    public Result update(@RequestBody Carousel carousel) {
        ...
        String result = nanShopMallCarouselService.updateCarousel(carousel);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Integer id) {
        Carousel carousel = nanShopMallCarouselService.getCarouselById(id);
        if (carousel == null) {
    ...
    public Result delete(@RequestBody Integer[] ids) {
        ...
        if (nanShopMallCarouselService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
