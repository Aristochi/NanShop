...
public class NanShopMallUserController {
    ...
    public String usersPage(HttpServletRequest request) {
        ...
        return "admin/nanShop_mall_user";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(nanShopMallUserService.getNanShopMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (nanShopMallUserService.lockUsers(ids, lockStatus)) {
