...
import com.NanShop.mall.util.NanShopMallUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        try {
            ...
            resultSuccess.setData(NanShopMallUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
